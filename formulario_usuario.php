...
<head>
    <meta charset="utf-8" />
    <title>Xacton - Admin & Dashboard Template / Formulario</title>
                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="simpleinput" class="form-control" placeholder="Ingresa Número de DNI">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="simpleinput" class="form-control" placeholder="Número de Telefono">
                                        </div>
                                        <div class="form-group">
                                            <label for="simpleinput">Dirección:</label>
                                            <input type="text" id="simpleinput" class="form-control" placeholder="Ingresa tu dirección">
                                        </div>
                                        <div class="form-group">
                                            <label for="simpleinput">Fecha de Nacimiento:</label>
                                            <input type="date" id="simpleinput" class="form-control" placeholder="Fecha_nac">
                                        </div>
                                        <div class="form-group">
