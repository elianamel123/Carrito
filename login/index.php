                        ...
                        <div class="w-100 d-block bg-white shadow-lg rounded my-5">
                            <div class="row">
                                <div class="col-lg-5 d-none d-lg-block rounded-left">
                                    <img src="../plantilla/Admin/vertical/assets/images/login 1.png" width="500" height="634" alt="">
                                </div>
                                <div class="col-lg-7">
                                    <div class="p-5">
                                        ...
                                        <h1 class="h5 mb-1 text-center">¡¡Bienvenido!!</h1>
                                        <p class="text-muted mb-4 text-center">Ingresa tu usuario y contraseña para acceder a nuestro Carrito de Compras</p>
                                        <form class="user">
                                            <div class="form-group">
                                                <input type="email" class="form-control form-control-user" id="exampleInputEmail" placeholder="Ingrese Usuario">
                                            </div>
                                            <div class="form-group">
