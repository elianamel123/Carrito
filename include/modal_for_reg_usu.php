    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title h4" id="myLargeModalLabel">For - Usu</h5>
            ...
            <div class="modal-body">
                <form action="Operaciones/registrar_usuario.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" name="nombre" class="form-control col-lg-9 col-md-9 col-sm-12" required>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-md-3 col-sm-12"> Correo: </label>
                        <input type="Emai" name="email" class="form-control col-lg-9 col-md-9 col-sm-12" required>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" name="direc" class="form-control col-lg-9 col-md-9 col-sm-12" required>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="file" name="foto" class="form-control col-lg-4 col-md-4 col-sm-12" require accept="image/*">
                    </div>
